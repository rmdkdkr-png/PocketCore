...
| 게임 | 한글패치 | 부가 기능 |
|---|---|---|
| SNK vs. Capcom — 정상결전 최강 파이터즈 | v0.19 | 원버튼 필살기 엔진 |
| 사무라이 스피리츠! 2 | v0.99b4 | 캐릭터 해설 + 한국어 더빙(음성팩) |
| 사무라이 스피리츠! | v0.19 |  |
| 월화의 검사 특별편 | v2.3 |  |
| 더 킹 오브 파이터즈 R-2 | v0.2.3 |  |
| 아랑전설 퍼스트 컨택트 | v0.1a |  |
| SNK vs. 캡콤 카드 파이터즈 클래시 | v0.11 | 영문판(UE) 전용 — 일본판에는 안 맞습니다 |
| 메탈슬러그 1st 미션 | v0.1 |  |
| 메탈슬러그 2nd 미션 | v0.7 |  |
