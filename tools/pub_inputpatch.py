...
(실측: 누른 뒤 10프레임째 시작), 그 뒤에 기술 자체의 발동이 붙습니다. 예를 들어 쿄 서서 강펀은 누름→명중 **26프레임**
(시작까지 10 + 모션 16), 하오마루는 **37프레임**. 아케이드 원작엔 없는 손해입니다. 여기 패치들은 모션 쪽에서 **그 손해만큼만**
돌려주고(쿄 26→20), 누르는 길이로 약/강을 가르는 방식·대미지·판정은 그대로 둡니다.
...
- SvC v1.4 — 11기술, 16바이트. **실제 2버튼 홀드 기준 누름→명중(에뮬 실측)**: 강펀 쿄 26→20 · 하오마루 37→29 · 나코루루 26→22 · 장기에프 24→20 · 모리간 24→20 · 이오리 24→20 / 강킥 레오나 30→24 · 하오마루 29→23 · 나코루루 32→28 · 셰르미 26→24 · 야시로 24→22. 나머지 기술은 원본 그대로(예: 류 강펀 16, 가일 강펀 14). 약공격은 손대지 않음(쿄 약펀 12).
