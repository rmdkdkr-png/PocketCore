...
네오지오 포켓은 버튼이 A·B 둘뿐이라 **길게 누르면 강**입니다. 게임은 버튼을 8프레임쯤 눌러 본 뒤에야 강 모션을
시작하고, 거기에 기술 자체의 발동(쿄 강펀 16프레임)이 붙습니다. 그래서 쿄 서서 강펀은 **누름→명중 23프레임**, 하오마루는
34프레임 — 아케이드 원작(KOF'98 쿄 원거리 강펀 12)엔 없는 손해입니다. 여기 패치들은 모션 쪽에서 **그 손해만큼만**(6~8프레임)
돌려주고, 누르는 길이로 약/강을 가르는 방식·대미지·판정은 그대로 둡니다.
...
- SvC v1.4 — 11기술, 16바이트. **누름→명중(버튼이 눌린 첫 프레임 → 맞는 프레임, 2버튼 홀드, 에뮬 실측)**: 강펀 쿄 23→17 · 하오마루 34→26 · 나코루루 23→19 · 장기에프 21→17 · 모리간 21→17 · 이오리 21→17 / 강킥 레오나 27→21 · 하오마루 26→20 · 나코루루 29→25 · 셰르미 23→21 · 야시로 21→19. 나머지는 원본 그대로, 약공격은 손대지 않음.
- KOF R-2 v1.1 — 8기술, 11바이트. 같은 잣대로 쿄 강펀 **23→17**(SvC 와 같은 값), 나머지 7기술도 각 6프레임 단축.
