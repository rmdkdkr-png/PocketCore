...
FULLNAME_OLD = {'svc':'SNK vs. Capcom — 정상결전 최강 파이터즈','ss2':'사무라이 스피리츠! 2',
            'ss1':'사무라이 스피리츠!','lb':'월화의 검사 특별편',
...
SUBS_OLD = {
    ...
    'ss2':   '1999 · 대전격투 · 사무라이 스피리츠',
    'ss1':   '1998 · 대전격투 · 사무라이 스피리츠',
    'lb':    '2000 · 대전격투 · 월화의 검사',
    'kofr2': '1999 · 대전격투 · KOF',
    'ffc':   '1999 · 대전격투 · 아랑전설',
    'ms1':   '1999 · 런앤건 · 메탈슬러그',
...
CORE_META_OLD = {
    ...
    'ss2': ('사무쇼2 코어 (해설·더빙)',
        "PocketCore 의 **사무라이 스피리츠! 2** 전용 코어입니다. 캐릭터 해설 자막과\n"
